...
namespace Neo.Plugins.Trackers.NEP_11
{
    class Nep11Tracker : TrackerBase
    {
        ...
        {
            Result.True_Or(_params.Count >= 1 || _params.Count <= 3, RpcError.InvalidParams.WithData("need an address, a startTime(optional), a endTime(optional)."));
        ...
        {
            Result.True_Or(_params.Count == 2, RpcError.InvalidParams.WithData("need a contract hash, a tokenId."));
