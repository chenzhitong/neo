...
namespace Neo.Plugins.RpcServer
{
    partial class RpcServer
    {
        ...
        {
            Result.True_Or(_params.Count >= 2 || _params.Count <= 4, RpcError.InvalidParams.WithData("need a script hash, an operation, an array of parameters, a signers(optional)."));
        ...
        {
            Result.True_Or(_params.Count == 1 || _params.Count == 2, RpcError.InvalidParams.WithData("need a script, a signers(optional)."));
        ...
        {
            Result.True_Or(_params.Count == 3, RpcError.InvalidParams.WithData("need a session, an iterator id, a count."));
